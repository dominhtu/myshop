            ...
            <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
                <div class="box-footer info-contact">
                    ...
                    <div class="content-contact">
                        <p>Website by Nhom 12</p>
                        <p>
                            <strong>Địa chỉ:</strong> Thu Duc College of Technology
                        </p>
                        <p>
                            <strong>Email: </strong> nhom12@gmail.com
                        </p>
                        <p>
                            <strong>Điện thoại: </strong> 012456xxx
                        </p>
                        <p>
                            <strong>Website: </strong> https://hocwordpress.org
                        </p>
                    </div>
                </div>
            </div>
